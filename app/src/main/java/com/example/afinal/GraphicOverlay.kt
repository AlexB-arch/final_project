...
class GraphicOverlay(context: Context?, attrs: AttributeSet?) :
    ...
    abstract class Graphic(private val overlay: GraphicOverlay?) {
        ...
        private fun scale(imagePixel: Float): Float {
            return imagePixel * (overlay?.scaleFactor ?: 1.0f)
        }
        ...
        fun isImageFlipped(): Boolean {
            return overlay?.isImageFlipped ?: false
        }
        ...
        fun translateX(x: Float): Float {
            return if (overlay?.isImageFlipped == true) {
                ...
                scale(x) - (overlay?.postScaleWidthOffset ?: 0f)
            }
        }
        ...
        fun translateY(y: Float): Float {
            return scale(y) - (overlay?.postScaleHeightOffset ?: 0f)
        }
        ...
        fun getTransformationMatrix(): Matrix {
            return overlay?.transformationMatrix ?: Matrix()
        }
    ...
    fun getImageHeight(): Any {
        return imageHeight
    }

    fun getImageWidth(): Any {
        return imageWidth
    }
}